...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            String itog = calc(str);
            System.out.println(itog);
        } catch (Exception e) {
            System.out.println("throws Exception // Используются одновременно разные системы счисления или некорректные данные (буквы, дроби и тд...)");
        }
    ...
    public static String calc(String input) throws Exception {
        ...
        Input inputs = new Input();
        inputs.strUserInput = input; // Передача строки, что ввел юзер
...
class Input {
    ...
    // Считываем данные с клавиатуры для понимания, что ввел юзер
    int whatNumber () {

        int count = 0;
        String strWhatNumber = strUserInput.replaceAll("\\s+","");
    ...
    String exit () throws Exception {
        ...
        if (i.equals("1")) {
            String otv = String.valueOf(this.numberArab(strUserInput));
            if (!otv.equals("101"))
                return String.valueOf(this.numberArab(strUserInput));
        } else if (i.equals("0")) {
    ...
    // Проверка на ошибки и работа  с араб цифрами
    ...
    // Проверка на ошибки и работа  с рим цифрами
